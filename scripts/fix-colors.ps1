# Script to replace all non-orange colors with orange theme colors
$targetPath = "D:\Capstone\elderly-home-care-app\app\careseeker"
...
Write-Host "`nColor replacement completed!"
